...
itk.Skybox = function(parent, texprefix)
{
    var Skybox = {
        ...
        _injectSkybox: function(parent)
        {
            ...
            el2d.style.perspective = "1200";
            el2d.style.transformStyle = 'preserve-3d';
            ...
            el2d.style.transform = 'translateX(512px) translateY(512px)';
        ...
        _injectSkyboxSide: function(parent, imgname, rotx, roty, rotz)
        {
            ...
            el.style.transformStyle = 'preserve-3d';
            el.style.transform = 'translateX(-'+s2+'px) translateY(-'+s2+'px) rotateX('+rotx+'deg) rotateY('+roty+'deg) rotateZ('+rotz+') translateZ(-'+2048+'px) scale(8)';
        ...
        _injectSkyboxSideObject: function(parent, objid, rotx, roty, rotz, tx, ty)
        {
            ...
            el.style.transformStyle = 'preserve-3d';
            el.style.transform = 'translateX(-'+s2+'px) translateY(-'+s2+'px) rotateX('+rotx+'deg) rotateY('+roty+'deg) rotateZ('+rotz+') translateZ(-2000px) translateX('+tx+'px) translateY('+ty+'px)';
            el.style.backfaceVisibility = "hidden";
...
/*
        ...
        changeTexture: function(texprefix) {
            ...
            $(this.sid+"_img_front").src = texprefix+"front.png";
        ...
        setRotation: function(rx,ry,rz) {
          ...
          $(this.sid).style.transform = 'translateZ(0px) rotateZ('+rz+'deg) rotateX('+rx+'deg) rotateY('+ry+'deg)';
        },
